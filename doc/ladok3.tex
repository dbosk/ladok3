...
\affil{%
  KTH EECS\\
  \texttt{\{alba,dbosk,maguire,chohm\}@kth.se}
}
...
results from Canvas to LADOK for the introductory programming course DD1315.
...
\inputminted{python}{../examples/canvas2ladok.py}
